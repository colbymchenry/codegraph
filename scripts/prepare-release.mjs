...
/**
 * Append a `[X.Y.Z]: https://github.com/zren-zing/codegraph-qt/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/zren-zing/codegraph-qt/releases/tag/v${version}`;
