'use strict';
//
// Programmatic / embedded SDK entry for @zren-zing/codegraph-qt (issue #354).
//
...
// API — `require("@zren-zing/codegraph-qt")` returning the CodeGraph class et al.
//
// The compiled library + its production dependencies (web-tree-sitter,
// tree-sitter-wasms, …) ship INSIDE the per-platform bundle, at
//   @zren-zing/codegraph-qt-<platform>-<arch>/lib/dist/index.js
...
var pkg = '@zren-zing/codegraph-qt-' + target;
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @zren-zing/codegraph-qt --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @zren-zing/codegraph-qt status`) to\n' +
