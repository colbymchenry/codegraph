...
| **20+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Swift, Kotlin, Dart, Lua, Luau, Verilog/SystemVerilog, Svelte, Liquid, Pascal/Delphi |
...
| Verilog / SystemVerilog | `.v`, `.vh`, `.sv`, `.svh` | Modules, interfaces, packages, functions/tasks, parameters, typedefs, package imports, and module-instantiation edges |
