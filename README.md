...
| Verilog / SystemVerilog | `.v`, `.vh`, `.sv`, `.svh` | Модули и именованные instances, generate scopes, порты/сигналы и named/positional/wildcard port bindings, bit/part selects, always/assign, interfaces/modports, package calls и иерархия instantiates; синтаксические связи без elaboration/timing |
