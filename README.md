...
<p align="center">
  ...
  <img src="https://raw.githubusercontent.com/colbymchenry/codegraph/main/assets/languages/crystal.svg?v=1" width="104" height="104" alt="Crystal" />
...
| **20+ Languages** | TypeScript, JavaScript, ArkTS, Python, Go, Rust, Java, C#, VB.NET, PHP, Ruby, C, C++, CUDA, Objective-C, Metal, Swift, Kotlin, Scala, Dart, Crystal, Lua, Luau, R, Nix, Erlang, CFML, COBOL, Solidity, Terraform/OpenTofu, Svelte, Vue, Astro, Liquid, Pascal/Delphi |
...
| Crystal | `.cr` | Full support (modules, classes, structs, enums, `lib`/`fun` C bindings, macros, `getter`/`setter`/`property` accessor macros, instance/class variables, type aliases, `require` imports, `<` inheritance and `include`/`extend` mixin edges, call edges through parenthesis-less and receiver-qualified calls) |
| C | `.c`, `.h` | Full support |
