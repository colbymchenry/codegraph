...
| **22+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Objective-C, Swift, Kotlin, Scala, Dart, ReScript, Lua, Luau, R, Svelte, Vue, Astro, Liquid, Pascal/Delphi |
