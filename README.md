...
| Verilog / SystemVerilog | `.v`, `.vh`, `.sv`, `.svh` | Модули, interfaces/packages, functions/tasks, parameters, typedefs, imports/includes и иерархия instantiates; без анализа сигналов и timing |
