...
| Verilog / SystemVerilog | `.v`, `.vh`, `.sv`, `.svh` | Модули и именованные instances, generate scopes, порты/сигналы, always/assign, interfaces/modports, package calls и иерархия instantiates; синтаксические связи без elaboration/timing |
