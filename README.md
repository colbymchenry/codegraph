...
| **20+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Swift, Kotlin, Dart, ArkTS, Lua, Luau, Svelte, Liquid, Pascal/Delphi, Scala |
...
| ArkTS | `.ets` | Full support (functions, classes, components/structs, interfaces, enums, type aliases, decorators, @Builder, ArkUI UI syntax) |
