...
Run `npx @zren-zing/codegraph-qt` and pick your agent(s); see [Installation](/codegraph/getting-started/installation/) for the non-interactive flags.
...
```bash
npm install -g @zren-zing/codegraph-qt
```
