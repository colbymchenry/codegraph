...
The `ui` command and `web` alias are unavailable in the next release candidate. Viewer source/assets remain packaged. Use `codegraph extensions connect` for the separate extension companion.
