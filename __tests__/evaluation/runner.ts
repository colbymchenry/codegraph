...
if (!codebasePath) {
  console.error('Usage: EVAL_CODEBASE=/path/to/codebase bun __tests__/evaluation/runner.ts');
  console.error('   or: bun __tests__/evaluation/runner.ts /path/to/codebase');
  process.exit(1);
}
